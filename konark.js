...
/*
   IMPORTANT:
   HTML uses id="konarkMusic"
*/

const odishaMusic =
    document.getElementById("konarkMusic");
...
function showInfo(type) {
    ...
    /* Stop Odisha music whenever another discovery opens */
    ...
    ================================================== */
        ...
        image.src =
            "assets/konark-architecture.jpg";
    }
...
/* =====================================================
   PLAY / PAUSE ODISHA MUSIC
===================================================== */

function toggleMusic() {

    if (!odishaMusic) {
        console.log("Odisha music element not found.");
        return;
    }
...
/* =====================================================
   KONARK BACKGROUND MUSIC
===================================================== */

const backgroundMusic =
    document.getElementById("backgroundMusic");

const konarkSoundBtn =
    document.getElementById("konarkSoundBtn");

let konarkMusicPlaying = false;
...
window.addEventListener("load", function () {
    ...
    backgroundMusic.play()
        .then(function () {
            ...
            konarkMusicPlaying = true;

            if (konarkSoundBtn) {
                konarkSoundBtn.textContent = "🔊";
            }
        ...
        .catch(function () {
            ...
            /*
               ...
               First interaction will start it.
            */

            konarkMusicPlaying = false;
...
if (konarkSoundBtn) {
    ...
    konarkSoundBtn.addEventListener(
        "click",
        function (event) {

            /*
               Prevent the global click listener
               from interfering with the sound button.
            */
